...
namespace test
{
    public partial class ModifyStuEntAge : Form
    {
        public ModifyStuEntAge()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sql = "UPDATE StudentInfo SET EntAge='" + modvalue.Text + "' WHERE StuID='" + stuIDTextBox.Text + "'";
                adapter.UpdateCommand = connection.CreateCommand();
                adapter.UpdateCommand.CommandText = sql;
                adapter.UpdateCommand.ExecuteNonQuery();
                MessageBox.Show("EntAge updated.", "TABLE VALUE UPDATED");
            }
        }
    }
}
