...
namespace test
{
    public partial class ModifyStuSex : Form
    {
        public ModifyStuSex()
        {
            InitializeComponent();
        ...
        private void save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sql = "UPDATE StudentInfo SET Sex='" + modvalue.Text + "' WHERE StuID='" + stuIDTextBox.Text + "'";
                adapter.UpdateCommand = connection.CreateCommand();
                adapter.UpdateCommand.CommandText = sql;
                adapter.UpdateCommand.ExecuteNonQuery();
                MessageBox.Show("Sex updated.", "TABLE VALUE UPDATED");
            }
        }
    }
}
