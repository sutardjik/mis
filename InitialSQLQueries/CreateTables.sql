...
CREATE TABLE TeacherInfo(
	TeacherID VARCHAR(5) UNIQUE NOT NULL,
...
CREATE TABLE CourseInfo(
	CourseID VARCHAR(7) UNIQUE NOT NULL,
	...
	FOREIGN KEY (TeacherID) REFERENCES TeacherInfo ON DELETE CASCADE
)
...
CREATE TABLE ChooseCourse(
	...
	Score INT NULL,
	FOREIGN KEY (StuID) REFERENCES StudentInfo ON DELETE CASCADE,
	FOREIGN KEY (TeacherID) REFERENCES TeacherInfo,
	FOREIGN KEY (CourseID) REFERENCES CourseInfo ON DELETE CASCADE
)
...
CREATE TABLE AdminAuthority(
	AdminID VARCHAR(7) UNIQUE NOT NULL,
